...
PM_START_TEXT = """ Hello *{}*, My name is *{}*! (https://telegra.ph/file/03d7f9a3b88879adbbbfe.jpg)
...
def yone_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text="""Hello *{}*, My name is *{}*. A Powerful Telegram Group Management Bot built to help you manage Group easily.(https://telegra.ph/file/03d7f9a3b88879adbbbfe.jpg)
